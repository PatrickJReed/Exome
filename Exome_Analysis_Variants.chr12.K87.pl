...
#	`java -Xmx8g -Djava.io.tmpdir=./tmp -jar $gatk -R $ref_fa -T ApplyRecalibration -log $ID.var_log3 --input $ID.both.vcf --mode BOTH -recalFile $ID.recal -tranchesFile $ID.tranches -o $ID.recal_Both.vcf`;
	...
	`java -Xmx8g -Djava.io.tmpdir=./tmp -jar $gatk -R $ref_fa -T HaplotypeCaller -A DepthPerAlleleBySample -L chr12 -log $ID.hap_chr12_log --dbsnp $dbsnp_vcf -I $K87_450 -I $K87_452 -I $K87_925 -I $K87_926 -I $K87_927 -I $K87_929 -I $K87_930 -o $ID.chr12.haplotypes.vcf -maxAltAlleles 8`;
