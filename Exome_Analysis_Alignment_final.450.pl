...
my $sample1_1	= "2012-450_120406_SN673_0136_AD0MEMACXX_8_1_sequence.txt.gz";
my $sample1_2	= "2012-450_120406_SN673_0136_AD0MEMACXX_8_2_sequence.txt.gz";
...
# Merge clipped and merged alignments
	...
	`java -Xmx8g -Djava.io.tmpdir=./tmp -jar $picard/MergeSamFiles.jar I=$ID.1.PE.srt.bam I=$ID.1.SE.srt.bam O=$ID.srt.bam SO=coordinate AS=true USE_THREADING=true`;
