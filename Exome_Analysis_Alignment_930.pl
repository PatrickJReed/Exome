...
#prep PE reads, merge and clip
	...
	# Merge SE reads, remove duplicates	
		...
		`java -Xmx8g -jar $picard/MergeSamFiles.jar I=$ID.1.mrg.srt.bam I=$ID.2.mrg.srt.bam I=$ID.3.mrg.srt.bam I=$ID.QC_1.srt.bam O=$ID.mrg.srt.bam SO=coordinate AS=true USE_THREADING=true`;
